...
export default function Settings() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div><h2 className="text-xl font-bold text-text-primary flex items-center gap-2"><SettingsIcon className="w-5 h-5 text-wa-green" />Bot Settings</h2><p className="text-sm text-text-muted mt-1">Configure your bot behavior and appearance</p></div>
      ...
      <div className="glass rounded-xl px-4 py-3 flex items-center gap-2"><Save className="w-4 h-4 text-wa-green" /><span className="text-xs text-text-muted">Settings are auto-saved to local storage</span></div>
    </div>
  );
}
